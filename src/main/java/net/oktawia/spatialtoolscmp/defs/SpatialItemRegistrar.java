...
public class SpatialItemRegistrar {
    ...
    public static final RegistryObject<PortableSpatialStorage> PORTABLE_SPATIAL_STORAGE = ITEMS.register(
            "portable_spatial_storage",
            () -> new PortableSpatialStorage(new Item.Properties()));

    public static final RegistryObject<PortableSpatialCloner> PORTABLE_SPATIAL_CLONER = ITEMS.register(
            "portable_spatial_cloner",
            () -> new PortableSpatialCloner(new Item.Properties()));

    public static final RegistryObject<PortableSpatialReplacer> PORTABLE_SPATIAL_REPLACER = ITEMS.register(
            "portable_spatial_replacer",
            () -> new PortableSpatialReplacer(new Item.Properties()));

    public static final RegistryObject<PortableSpatialPiper> PORTABLE_SPATIAL_PIPER = ITEMS.register(
            "portable_spatial_piper",
            () -> new PortableSpatialPiper(new Item.Properties()));

    public static final RegistryObject<PortableSpatialTool> PORTABLE_SPATIAL_TOOL = ITEMS.register(
            "portable_spatial_tool",
